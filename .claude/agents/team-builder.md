...
Run the discovery script to catalog available resources:
...
- Load template from `~/.claude/skills/team-builder/references/team-templates.md`
...
Read `~/.claude/skills/team-builder/references/composition-guide.md` for detailed guidance on:
