---
allowed-tools: Read, Write, Bash, Grep, Glob, mcp__sequential-thinking__sequentialthinking, mcp__serena__search_for_pattern, mcp__serena__find_symbol, mcp__serena__read_memory, mcp__serena__write_memory
