---
allowed-tools: Read, Write, Bash, Grep, Glob, Edit, mcp__serena__get_symbols_overview, mcp__serena__list_dir, mcp__sequential-thinking__sequentialthinking, mcp__serena__search_for_pattern
